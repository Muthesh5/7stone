...
function keyPressed(){
  if(keyCode === 32){
    Matter.Body.setPosition(stone.body,{x:120 ,y:300 })
...
{
  // var ai = await fetch("http://worldtimeapi.org/api/timezone/Asia/Kolkata");
  // var jsn = await ai.json()
  //   var datetime=jsn.datetime;
